...
addon = xbmcaddon.Addon('plugin.video.Lithu.streams')
...
def getData(url,fanart):
        ...
        if len(soup('channels')) > 0:
            ...
            for channel in channels:
                ...
                if len(feedurl) > 0:
                    try:                    
                        addDir(name.encode('utf-8', 'ignore'),feedurl.encode('utf-8'),1,thumbnail,fanArt,desc,genre,date,credits,True)
